...
export default function Page(){
 const path=usePathname(),router=useRouter(),isAch=path==="/achievements",isProgress=path==="/progress",isPathways=path==="/pathways";
 ...
 <div className="content">{isAch?<Achievements/>:isProgress?<Progress/>:isPathways?<Pathways/>:<Timer/>}</div><div className="status-bar"><span><i/> Systems normal</span><span>Study X · 2026</span></div></div>
function Progress(){
