...
function Timer(){
 ...
 return <main className="timer-page">
  ...
  <div className="timer-main-grid"><div className="timer-primary">
  ...
  <div className="bottom-tools"><button onClick={()=>document.getElementById("task-list")?.scrollIntoView({behavior:"smooth"})}>Tasks</button><button onClick={()=>setSound(v=>!v)}>{sound?"Sound on":"Sound off"}</button><button>Ambient</button><button>Study room</button></div></div>
  ...
  </section></div><div className="timer-meta"><span>25:00 recommended</span><span>Session 01</span><span>Distraction-free</span></div>
 </main>
}
