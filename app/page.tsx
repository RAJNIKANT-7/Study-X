...
export default function Page(){
 const path=usePathname(),router=useRouter(),[loginOpen,setLoginOpen]=useState(false),[account,setAccount]=useState<string|null>(null),isAch=path==="/achievements",isProgress=path==="/progress",isSyllabus=path==="/syllabus",isLeaderboard=path==="/leaderboard";
